...
func TestMaterialUploadedEvent_GetS3Key(t *testing.T) {
	tests := []struct {
		...
		{
			name: "extrae key desde URL de Cloudflare R2",
			event: MaterialUploadedEvent{
				EventID:      "evt-123",
				EventType:    "material.uploaded",
				EventVersion: "1.0.0",
				...
				Payload: MaterialUploadedPayload{
					...
					SchoolID:      "school-789",
					TeacherID:     "teacher-101",
					FileURL:       "https://fa88e11fa0af310c2025d21c23aab6df.r2.cloudflarestorage.com/edugo-materials/materials/mat-456/original",
					FileSizeBytes: 1024000,
					FileType:      "application/pdf",
				},
			},
			expected: "materials/mat-456/original",
		},
		{
			name: "extrae key desde URL de R2 con extensión pdf",
			event: MaterialUploadedEvent{
				EventID:      "evt-123",
				EventType:    "material.uploaded",
				EventVersion: "1.0.0",
				...
				Payload: MaterialUploadedPayload{
					...
					SchoolID:      "school-789",
					TeacherID:     "teacher-101",
					FileURL:       "https://xxx.r2.cloudflarestorage.com/my-bucket/docs/file.pdf",
					FileSizeBytes: 1024000,
					FileType:      "application/pdf",
				},
			},
			expected: "docs/file.pdf",
		},
		{
